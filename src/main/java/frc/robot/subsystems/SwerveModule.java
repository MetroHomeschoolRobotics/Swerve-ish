...
public class SwerveModule {
  ...
  private Double angleMotorSpeedOffset;
  ...
  public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants) {
    ...
    angleMotorSpeedOffset = moduleConstants.angleMotorSpeedOffset;
   ...
   * integratedAngleEncoder.setPositionConversionFactor(Constants.Swerve.
  ...
  public void setAngleMotorSpeed(double speed) {    
    angleMotor.set(speed + angleMotorSpeedOffset);
  }
