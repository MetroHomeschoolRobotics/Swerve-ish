...
public class Swerve extends SubsystemBase {
  ...
  public SwerveModulePosition[] getModulePositions(){
    ...
    for (SwerveModule mod : mSwerveMods) {
      positions[mod.moduleNumber] = mod.getPosition();//mod.getPosition();
    }
    return positions;
  }
  ...
  public void periodic() {
    ...
    for (SwerveModule mod : mSwerveMods) {
      SmartDashboard.putNumber(
          "Mod " + mod.moduleNumber + " AngleEncoder", mod.getAngle().getDegrees());
      SmartDashboard.putNumber(
          "Mod " + mod.moduleNumber + " DriveEncoder", mod.getPosition().distanceMeters);
      SmartDashboard.putNumber(
